<div id="header" align="center">
  <img src="https://user-images.githubusercontent.com/66737451/217129382-0977e3db-bf54-438b-a128-8080c2786b48.png" width="300" height="200">
</div>
...
<details open>
  <summary> How to register </summary>
    ...
    1. Once you are on the landing page check the top right corner of the screen and click on 'Registrarse'.
    2. On the register page fill up all the required fields.
    3. Press 'Crear Cuenta' and that should do it.
  
</details>

<details open>
  <summary> How to log in</summary>
  
    1. Once you are on the landing page check the top right corner of the screen and click on 'Iniciar Sesión'.
    2. On the login page fill up all the required fields.
    3. Press 'Enviar' and this should unlock the below fields.
    4. Press 'mostar' and a pop up window should appear with a token, copy the token and close the window.
    5. Enter the token and press 'Comprobar', this should take you to the user page if everything is correct.
...
## 📸 Screenshots
  ...
  | <h3>User Page</h3> | <img src="https://user-images.githubusercontent.com/66737451/217136519-41c00dbd-18a9-4288-a873-04e38fafd29e.png" width="700"/> |
